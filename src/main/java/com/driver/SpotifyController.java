...
public class SpotifyController {
    ...
    public String createSong(@RequestParam String title, @RequestParam String albumName, int length) throws Exception{
    ...
    public String createPlaylistOnLength(String mobile, String title, int length) throws Exception{
        ...
        //If the user does not exist, throw "User does not exist" exceptionspo
